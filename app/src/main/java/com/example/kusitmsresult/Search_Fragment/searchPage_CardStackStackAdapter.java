...
class searchPage_CardStackAdapter extends RecyclerView.Adapter<searchPage_CardStackAdapter.ViewHolder> {

    private List<Personal_Information> items;

    public searchPage_CardStackAdapter(List<Personal_Information> items) {
        this.items = items;
    }
